...
@section('page_content')
    ...
    <div class="panel panel-primary" data-collapsed="0">
        <div class="panel-body">
            ...
            <div id="upload_assignment_modal" class="modal fade"
            role="dialog" tabindex="-1">
           <div class="modal-dialog">
               ...
               <form action="{{url('student/assignment_upload')}}" class="form-horizontal form-groups-bordered validate"
                   ...
                   <div class="modal-content">
                       <div class="modal-header">
                           <h4 class="modal-title" style="text-align: center">Upload Assignment</h4>
                       </div>
                       <div class="modal-body">
                           <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function initialise_table() {
            ...
            student_table.DataTable({
                ...
                "ajax": {
                    "type": 'POST',
                    "url": '{{url('student/get_assignment_data')}}',
                    "data" : {
                        "_token": "{{ csrf_token() }}"
                    },
                },
        ...
        function upload_assignment_modal(idAssignment, assignment_name) {
            $('#idAssignment').val(idAssignment);
            $('#assignment_name').val(assignment_name);
           // $('#email').val(email);
            $('#upload_assignment_modal').modal('show');
        }
